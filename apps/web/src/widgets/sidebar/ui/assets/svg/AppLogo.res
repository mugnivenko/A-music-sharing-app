...
let make = () => {
  <SvgIcon>
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="Mytones~ Music Streaming Web" clipPath="url(#clip0_0_1)">
        <rect width="1440" height="900" transform="translate(-61 -37)" fill="#F9F9FB" />
        <g id="Group 31">
          <rect id="Rectangle 47" x="-61" y="-37" width="260" height="900" fill="white" />
          <g id="logo">
            <g id="logo_2">
              <rect id="Rectangle 59" width="24" height="24" rx="12" fill="#4343EF" />
              <path
                id="Vector"
      ...
      <defs>
        <clipPath id="clip0_0_1">
          <rect width="1440" height="900" fill="white" transform="translate(-61 -37)" />
        </clipPath>
      </defs>
    </svg>
  </SvgIcon>
